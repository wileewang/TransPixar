...
class BasePipeline:
    ...
    def configure_adapter(self, adapter_config):
        ...
        for name, module in self.transformer.named_modules():
            ...
            for full_submodule_name, submodule in module.named_modules(prefix=name):
                if isinstance(submodule, nn.Linear) and any(target in full_submodule_name for target in adapter_config['target_modules']):
        ...
        # if is_main_process():
        #     self.lora_model.print_trainable_parameters() # luozhou
    ...
    def load_adapter_weights(self, adapter_path):
        # if is_main_process():
        #     print(f'Loading adapter weights from path {adapter_path}') # luozhou
